...
public class UnitTestFixtures {
	 ...
	 * @return
	 */
	public static String getCreateRecordFixture(String script, String timeStr, String apexScriptFile,String CsvOrJson) {
		...
		String apexScript  = script 		
				...
				+ "utr.Data_CSV_File_Name__c = '"+CsvOrJson+"';" 
				+ "insert utr;";
	...
	/**
	 * Method to create order item (OLI)
	 * @param productName
	 * @param orderId
	 * @return
	 */
	public static String getCreateOrderItemFixture(String orderableClass, String productName, String orderId) {
		String apexScript  = orderableClass+"OrderProcessing.createOrderItem('"+productName+"','"+orderId+"');";
		return apexScript;
